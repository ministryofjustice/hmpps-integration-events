#!/bin/bash
##
## Converts the results of an SQL query containing tab delimited file (containing event-id, crn and the last updated datetime)
## into a domain event capable of being loaded into an hmpps-integration-api event queue
## e.g
##
## 1502011403      A123456 2017-03-15T15:47:51.000000
## 1502011452      A123457 2025-03-15T13:27:03.000000
##
## Usage:
...
do
  ...
  URL="https://$ENV.integration-api.hmpps.service.justice.gov.uk/v1/persons/$CRN"
  echo "{\"Type\":\"Notification\",\"MessageId\":\"...\",\"TopicArn\":\"...\",\"Message\":\"{\\\"eventId\\\":$EVENT_ID,\\\"hmppsId\\\":\\\"$CRN\\\",\\\"eventType\\\":\\\"$EVENT_TYPE\\\",\\\"prisonId\\\":\\\"TRN\\\",\\\"url\\\":\\\"$URL\\\",\\\"lastModifiedDateTime\\\":\\\"$LAST_UPDATED\\\"}\",\"Timestamp\":\"$TIMESTAMP\",\"SignatureVersion\":\"1\",\"Signature\":\"...\",\"SigningCertURL\":\"...\",\"UnsubscribeURL\":\"...\",\"MessageAttributes\":{\"prisonId\":{\"Type\":\"String\",\"Value\":\"TRN\"},\"eventType\":{\"Type\":\"String\",\"Value\":\"$EVENT_TYPE\"}}}"
