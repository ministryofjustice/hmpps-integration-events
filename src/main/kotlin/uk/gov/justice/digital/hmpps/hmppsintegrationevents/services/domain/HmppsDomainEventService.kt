...
interface HmppsDomainEventService {
  ...
  /**
   * Filter event [uk.gov.justice.digital.hmpps.hmppsintegrationevents.models.enums.IntegrationEventType] from domain event [HmppsDomainEvent], configurable with feature-flag.
   *
