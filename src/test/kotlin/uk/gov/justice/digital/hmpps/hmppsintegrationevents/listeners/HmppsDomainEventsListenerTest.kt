...
class HmppsDomainEventsListenerTest {
  ...
  val hmppsDomainEventsListener: HmppsDomainEventsListener = HmppsDomainEventsListener(registrationEventsService = mockRegistrationEventsService)

  @Test
  fun `when a registration sqs event is received it should call the registrationEventService`() {
